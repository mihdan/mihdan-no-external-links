	...
	public function upgrade() {
	    ...
	    if ( false === $installed_version || version_compare( $installed_version, '4.0.0', '<' ) ) {
            ...
            if ( false !== $current_options ) {
                ...
                if ( isset( $current_options[ 'fullmask' ] ) ) {
                    if ( '1' === $current_options[ 'fullmask' ] ) {
                ...
                if ( isset( $current_options[ 'LINK_SEP' ] ) && $current_options[ 'LINK_SEP' ] !== 'goto' ) {
                ...
                if ( isset( $current_options[ 'redtxt' ] ) ) {
                    if ( 'This page demonstrates link redirect with "WP-NoExternalLinks" plugin. You will be redirected in 3 seconds. Otherwise, please click on <a href="LINKURL">this link</a>.' !== $current_options[ 'redtxt' ] ) {
